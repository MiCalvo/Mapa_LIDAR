...
export const ELEMENTOS = [
  ...
  { id: 'visual', texto: 'Panel derecho «Vista / Canal» (3D)', sel: '.panel.der:not(.mapa)', ocultar: true },
  ...
  { id: 'punto', texto: 'Datos del punto (3D)', sel: '#tarjeta-punto', ocultar: true },
  { id: 'manantiales', texto: 'Leyenda y ficha de manantiales', sel: '#leyenda-manantiales, #tarjeta-manantial', ocultar: false },
